...
function wello_servicedesk_api_render_access_token_page() {
    ...
    $error_msg = '';
    $success_msg = '';
    $access_token = get_option('wello_servicedesk_token', '');
            ...
            if (is_wp_error($response)) {
                ...
                if ($code !== 200) {
                    ...
                    if (!empty($body['access_token'])) {
                        ...
                        update_option('wello_servicedesk_token', $access_token);
    ...
    <?php if (!empty($access_token)) : ?>
        ...
        <div style="margin-top: 20px;">
            <p><strong><?php echo esc_html__('Access Token:', 'wello-servicedesk-api'); ?></strong></p>
            <input type="text" id="access_token_display" value="<?php echo esc_attr($access_token); ?>" readonly style="width: 100%; max-width: 650px; margin-top: 10px;">
